...
class TestClientTransport(httpx2.BaseTransport):
    """
    A synchronous transport adapter for `httpx2` that routes requests directly to an ASGI
    application.
    ...
    def handle_request(self, request: httpx2.Request) -> httpx2.Response:
        ...
        Args:
            request (httpx2.Request): The incoming HTTP request object from the client.

        Returns:
            httpx2.Response: The response generated by the ASGI application.
    ...
    def _parse_url(
        ...
        Args:
            url (httpx2.URL): The URL object to parse.
    ...
    def _build_headers(
        self, request_headers: httpx2.Headers, host: str, port: int, default_port: int
        ...
        Args:
            request_headers (httpx2.Headers): The headers from the original request.
    ...
    def _handle_websocket_request(
        ...
        Args:
            request (httpx2.Request): The original upgrade request.
    ...
    def _build_http_scope(
        ...
        Args:
            request (httpx2.Request): The HTTP request object.
    ...
    def _process_http_request(
        self, scope: dict[str, Any], request: httpx2.Request
    ) -> httpx2.Response:
        """
        ...
        Args:
            ...
            request (httpx2.Request): The original HTTP request object.

        Returns:
            httpx2.Response: The constructed HTTP response object.
        ...
        # Convert the stream content to an httpx2.ByteStream for the final response
...
class AsyncTestClientTransport(httpx2.AsyncBaseTransport):
    """
    An asynchronous transport adapter for `httpx2` that routes requests directly to an ASGI
    application.
    ...
    async def handle_async_request(self, request: httpx2.Request) -> httpx2.Response:
        ...
        Args:
            request (httpx2.Request): The incoming request.

        Returns:
            httpx2.Response: The response from the ASGI app.
    ...
    def _parse_url(
        ...
        Args:
            url (httpx2.URL): The URL to parse.
    ...
    def _build_headers(
        ...
        Args:
            request_headers (httpx2.Headers): Original headers.
    ...
    async def _handle_websocket_request(
        ...
        Args:
            request (httpx2.Request): The upgrade request.
    ...
    async def _process_http_request(
        ...
        Args:
            ...
            request (httpx2.Request): The HTTP request.
