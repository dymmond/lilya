...
Please check the [minimum requirements](./scheduler.mdx#requirements) to use this feature within
your project.
...
Lilya allows to pass those configurations via application instantiation or via [settings](../../settings.mdx).
