...
The [AsynczConfig](./config.mdx) is the main object that manages the internal scheduler of `Lilya` with asyncz expecting:
...
You can have your own scheduler config class as well, check the [SchedulerConfig](./config.mdx#how-to-use-it).
...
the Asyncz default integration and adapt to your own needs. This is thanks to the [SchedulerConfig](./config.mdx#how-to-use-it)
...
:::tip
    There are more details about [how to create tasks](./handler.mdx) in the next section.
:::
