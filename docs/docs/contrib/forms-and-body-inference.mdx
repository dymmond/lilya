...
As you know, the body inference is activated via [settings](../settings.mdx) `infer_body=True`.
...
:::note
    ...
    [encoders](../encoders.mdx) section. **You still need to create your encoders for this to work, anyway**
:::
