...
[CSRFMiddleware](../../middleware.mdx#csrfmiddleware) protects your application against Cross‑Site Request Forgery (CSRF)
...
:::tip Using settings
    You can also configure the middleware via your settings `LILYA_SETTINGS_MODULE`. See the [Settings](../../settings.mdx) section.
:::
...
as the [TemplateController](../../templates.mdx#templatecontroller) to make it easier to show.
