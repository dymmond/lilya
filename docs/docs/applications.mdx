...
requests (HTTP and Websockets).
* **middleware** - A list of [middleware](./middleware.mdx) to run for every request. The middlewares can be subclasses of the [MiddlewareProtocol](./middleware.md#middlewareprotocol).
