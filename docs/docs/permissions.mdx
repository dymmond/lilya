...
*separation of concerns*. Interestingly, this permission system closely resembles [middlewares](./middleware.mdx).
...
As mentioned in the [settings](./settings.mdx) document, the permissions is one of the properties available
