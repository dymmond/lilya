...
If you want the [Lilya client](./lilya-cli.mdx) (for scaffolds, and other useful tools).
...
You can learn more about the [client](./directives/discovery.mdx) in the documentation.
...
A Lilya also uses a [native settings system](./settings.mdx) which is something that can be extremely useful
for any application.
...
In other words, you can build a [middleware](./middleware.mdx) or a [permission](./permissions.mdx) and
