...
[TrustedHostMiddleware](./middleware/trustedhost.mdx).
...
The  [TrustedReferrerMiddleware](./middleware/trustedreferrer.mdx) is a good tool for mitigating the risk of malicious parameter injection.
...
headers. The usage is documented in [SessionFixingMiddleware](./middleware.mdx#sessionfixingmiddleware).
