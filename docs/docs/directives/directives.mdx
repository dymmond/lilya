...
* [shell](./shell.mdx) - Starts the python interactive shell for your Lilya application.
...
` {!> ../../../docs_src/_shared/app_struct_example.mdx !} `
...
If you want another [settings](../settings.mdx#custom-settings) you can simply update the command to
...
` {!> ../../../docs_src/_shared/deployment_struct_example.mdx !} `
...
` {!> ../../../docs_src/_shared/deploy_struct_example.mdx !} `
...
:::warning
    The following examples and explanations will be using the [auto discovery](./discovery.mdx#auto-discovery)
    approach but the [--app and environment variables](./discovery.mdx#environment-variables)
