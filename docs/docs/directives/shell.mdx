...
but [--app and environment variables](./discovery.mdx#environment-variables) approach but the
...
#### With [auto discovery](./discovery.mdx#auto-discovery)
...
#### With [--app and environment variables](./discovery.mdx#environment-variables)
...
[more details](../settings.mdx) about the settings and [how to use them](../settings.mdx).
