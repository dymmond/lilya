...
def test_create_app_with_env_var(create_folders):
    ...
    (o, e, ss) = run_cmd("tests.cli.main:app", "lilya createapp myapp --version v10")
...
def test_create_app_without_env_var(create_folders):
    ...
    (o, e, ss) = run_cmd("tests.cli.main:app", "lilya createapp myapp --version v10", is_app=False)
...
def test_create_app_without_env_var_with_app_flag(create_folders):
    ...
    (o, e, ss) = run_cmd(
        "tests.cli.main:app",
        "lilya --app tests.cli.main:app createapp myapp --version v10",
        is_app=False,
    )
