...
def test_serve_flask_via_lilya(test_client_factory):
    routes = [
        ...
        Include("/flask", WSGIMiddleware("tests.middleware.test_wsgi_middleware_str.flask_app")),
    ]
...
def test_serve_flask_via_nested_include(test_client_factory):
    routes = [
        ...
        Include(
            ...
            routes=[
                Include(
                    "/flask", WSGIMiddleware("tests.middleware.test_wsgi_middleware_str.flask_app")
                ),
            ],
        ),
    ]
                                                ...
                                                Include(
                                                    ...
                                                    routes=[
                                                        Include(
                                                            "/flask",
                                                            WSGIMiddleware(
                                                                "tests.middleware.test_wsgi_middleware_str.flask_app"
                                                            ),
                                                        ),
                                                    ],
                                                ),
...
def test_serve_more_than_one_flask_app_via_lilya(test_client_factory):
    routes = [
        ...
        Include(
            "/second/flask",
            WSGIMiddleware("tests.middleware.test_wsgi_middleware_str.second_flask_app"),
        ),
    ]
                                ...
                                Include(
                                    ...
                                    routes=[
                                        Include(
                                            "/second/flask",
                                            WSGIMiddleware(
                                                "tests.middleware.test_wsgi_middleware_str.second_flask_app"
                                            ),
                                        ),
                                    ],
                                )
            ...
            routes=[
                ...
                Include(
                    ...
                    routes=[
                        Include(
                            "/flask",
                            WSGIMiddleware("tests.middleware.test_wsgi_middleware_str.flask_app"),
                        ),
                        Include(
                            "/second/flask",
                            WSGIMiddleware(
